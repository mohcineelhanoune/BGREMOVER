...
def setup_page():
    """Définit la configuration de la page Streamlit."""
    st.set_page_config(page_title="Background Remover", page_icon="✂️")
    hide_streamlit_style()


def hide_streamlit_style():
    """Masque le style par défaut de Streamlit."""
    st.markdown(
...
def display_ui():
    """Affiche l'interface utilisateur pour le téléchargement de fichiers et renvoie les fichiers téléchargés.."""
    st.sidebar.markdown("## Suppression de l'arrière-plan de l'image")
...
def display_footer():
    ...
    footer = """<div style="position: fixed; bottom: 0; left: 20px;">
                <p>Developed with ❤ by <a href="https://Mohcineelhanoune.art" target="_blank">Mohcineelhanoune.art</a></p>
                </div>"""
